...
#include "RPAT_PlayMontageAndWaitForEvents.generated.h"

/**
	Delegate type used, EventTag and Payload may be empty if it came from the montage callbacks
*/
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(
FRPPlayMontageAndWaitForEventsDelegate,
 ...
 */
UCLASS()
class RPGPROT_API URPAT_PlayMontageAndWaitForEvents : public UAbilityTask
{
	GENERATED_BODY()
	

public:
	URPAT_PlayMontageAndWaitForEvents(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	/** Called when the ability is cancel from outside node*/
	...
	UPROPERTY(BlueprintAssignable)
		FRPPlayMontageAndWaitForEventsDelegate OnCompleted;

	/** The montage started blending out */
	UPROPERTY(BlueprintAssignable)
		FRPPlayMontageAndWaitForEventsDelegate OnBlendOut;

	/** The montage was interrupted */
	UPROPERTY(BlueprintAssignable)
		FRPPlayMontageAndWaitForEventsDelegate OnInterrupted;

	/** The ability task was explicitly cancelled by another ability */
	UPROPERTY(BlueprintAssignable)
		FRPPlayMontageAndWaitForEventsDelegate OnCancelled;

	/** One of the triggering gameplay events happened */
	UPROPERTY(BlueprintAssignable)
		FRPPlayMontageAndWaitForEventsDelegate EventReceived;
	...
	UFUNCTION(BlueprintCallable, Category = "Ability|Tasks", meta = (HidePin = "OwningAbility", DefaultToSelf = "OwningAbility", BlueprintInternalUseOnly = "TRUE"))
		static URPAT_PlayMontageAndWaitForEvents* PlayMontageAndWaitForEvent(
...
private:
	...
	class URPAbilitySystemComponent* GetTargetASC();
